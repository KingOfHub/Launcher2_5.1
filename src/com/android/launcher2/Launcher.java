...
public final class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.PWV_CUSTOM_CUSTOM.equals("SYB")){
            LauncherApplication.DISPLAY_WALLPAPER_IN_ALLAPP = true;
        }
        mContext=this;

        if(Build.PROJECT.equals("SQ27T")) {
            SEManager msemanger = new SEManager();
            msemanger.setIndicatorLED(2, 0);
            msemanger.setIndicatorLED(3, 0);
            msemanger.setIndicatorLED(4, 0);
        }else if(Build.PROJECT.equals("SQ26TB")){
            SEManager msemanger=new SEManager();
            msemanger.setIndicatorLED(1,0);
            msemanger.setIndicatorLED(0,0);
            msemanger.setIndicatorLED(2,0);
        }else if(Build.PROJECT.equals("SQ27TC")||Build.PROJECT.equals("SQ27TE")){
            SEManager msemanger=new SEManager();
            msemanger.setIndicatorLED(2,0);
            msemanger.setIndicatorLED(3,0);
        }
